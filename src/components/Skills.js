    ...
    >
      ...
      >
        {services.map(({ id, image, title }) => (
          <div
            key={id}
            className="flex flex-col items-center justify-center p-5 shadow-lg dark:shadow-violet-500/60 rounded-full object-cover w-24 h-24 md:w-32 md:h-32 duration-300 ease-in-out hover:scale-110"
          >
            <img
              src={image}
              alt={title}
