  ...
  return (
    <Section id="about" title="About Me" subtitle="Full Stack Developer">
      <motion.div
        ...
        className="flex flex-col min-h-fit text-center xl:text-left xl:flex-row max-w-7xl px-10 mx-auto items-center md:pt-16 md:pb-16 md:mx-36 xl:mx-48"
      >
        <motion.img
          src={MukulImg}
        ...
        />
        <div className="space-y-10 px-0 md:px-10 xl:pt-0 xl:px-20 md:pt-10">
