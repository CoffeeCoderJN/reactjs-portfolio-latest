...
const Header = ({ darkMode, setDarkMode }) => {
  ...
  return (
    <header className="sticky bg-white/70 text-gray-900 dark:bg-neutral-900/70 dark:text-white top-0 z-40 duration-700 ease-in-out">
      <nav className="flex md:justify-around items-center backdrop-filter backdrop-blur-lg bg-opacity-30 px-5 py-3 md:py-3 justify-between border-divider-light/70 border-b dark:border-divider-dark/40">
        <motion.div
        ...
        >
          ...
          <div className="">
            <h1 className="font-yesteryear md:text-4xl text-3xl text-amber-500 underline">
              Mukul
            </h1>
          </div>
        </motion.div>
